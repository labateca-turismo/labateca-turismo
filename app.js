...
const I18N = {
  es:{
    ...
    hero_lead:"Cascadas que caen por la garganta entre dos montañas, café de altura y 2.000 hectáreas de Páramo de Santurbán. A tres horas y media de Cúcuta.",
    ...
    about_eyebrow:"El pueblo", about_title:"Un pueblo con 400 años de historia escrita",
    about_p1:"<strong>Labateca</strong> —“volcanes de Dios” en lengua chitarera— es un municipio de montaña que vive del café, de la ganadería y de unas cascadas a las que todavía se llega a pie.",
    ...
    qr_bajar_svg:"Versión vectorial (SVG)",
    qr_nota:"El PNG sirve para compartir e imprimir en cualquier parte. El SVG es vectorial: se amplia al tamaño de una valla sin que se pixele.",
    ...
    nav_routes:"Rutas",
    map_eyebrow:"Ubícate", map_title:"Todo Labateca en un mapa", map_sub:"Cada lugar con su punto, su distancia y el botón para que Google Maps te lleve.",
    ...
    gal_eyebrow:"Postales", gal_title:"Galería", gal_sub:"Siete lugares del pueblo. Toca cualquiera y se abre la galería completa de ese lugar.",
    ...
    ex_lead:"Pregunta lo que quieras: qué visitar, cómo llegar, qué comer o cómo armar tu recorrido. Responde al instante, en español o en inglés, y solo con lo que dicen las fichas de esta guía.",
  ...
  en:{
    ...
    hero_lead:"Waterfalls dropping through the gorge between two mountains, high-altitude coffee and 2,000 hectares of the Santurbán Páramo. Three and a half hours from Cúcuta.",
    ...
    about_eyebrow:"The town", about_title:"A town with 400 years of written history",
    about_p1:"<strong>Labateca</strong> —“God's volcanoes” in the Chitarera tongue— is a mountain town that lives on coffee, cattle and waterfalls you still reach on foot.",
    ...
    qr_bajar_svg:"Vector version (SVG)",
    qr_nota:"The PNG works anywhere for sharing and printing. The SVG is vector art: scale it to billboard size without it going blocky.",
    ...
    nav_routes:"Routes",
    map_eyebrow:"Find your way", map_title:"All of Labateca on one map", map_sub:"Every place with its pin, its distance and a button to let Google Maps take you there.",
    ...
    gal_eyebrow:"Postcards", gal_title:"Gallery", gal_sub:"Seven places in town. Tap any one to open that place’s full photo gallery.",
    ...
    ex_lead:"Ask anything: what to see, how to get there, what to eat or how to plan your day. It answers instantly, in Spanish or English, using only what this guide's entries say.",
...
function generatePDF() {
  ...
  loadJsPDF.then(jsPDF => {
    ...
    const CAT_LABELS_ES = { naturaleza:'Naturaleza', cultura:'Cultura', gastronomia:'Gastronomía', hospedaje:'Hospedaje', comercio:'Comercio', servicios:'Servicios' };
    const CAT_LABELS_EN = { naturaleza:'Nature', cultura:'Culture', gastronomia:'Food', hospedaje:'Lodging', comercio:'Shops', servicios:'Services' };
    ...
    const cats = ['naturaleza', 'cultura', 'gastronomia', 'hospedaje', 'comercio', 'servicios'];
    const bycat = {};
