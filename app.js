...
const I18N = {
  es:{
    ...
    qr_nota:"El archivo es vectorial: se puede imprimir del tamaño de un adhesivo o de una valla sin que se pixele.",
  ...
  en:{
    ...
    qr_nota:"The file is vector art: print it sticker-sized or billboard-sized without it going blocky.",
